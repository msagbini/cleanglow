...
window.CGI18N = (() => {
  ...
  const es = {
    ...
    'faq.a2': 'No es obligatorio. Puedes coordinar una caja de seguridad, con un vecino/administrador del edificio, o con tu administrador de propiedad al reservar.',
